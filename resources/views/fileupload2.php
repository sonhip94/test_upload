...
<div class="container">
    <div class="row">
        <div class="col-md-12">
			...
			Upload File:
			<input type="file" id="fileUploader" onchange="attachUploadListener" name="fileUploader" accept="*/*" />
		...
		<div class="span8">
			 <div class="progress progress-striped progress-success">
			  ...
			  <div class="span4">
				 <button class="btn stop" onclick="attachUploadListener" id="toggle-btn">upload</button>
			 </div>
	...
	<script type="text/javascript">
		function handleFileChange(e) {
			...
			var upload = new tus.Upload(file, {
                endpoint: "https://homestead.test/tus",
