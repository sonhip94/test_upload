...
<div class="container">
  ...
  <div class="text-center">
	<div class="col-lg-1" style="padding-top: 2rem;">
		<span style="font-size: 50px; color: #CD5C5C;" class="glyphicon glyphicon-alert" aria-hidden="true"></span>
	</div>	
	<div class="col-lg-1" style="padding-top: 2rem;">
		<span style="font-size: 50px;" class="glyphicon glyphicon-file" aria-hidden="true"></span>
	</div>	
...
<div class="container">
  ...
  <div class="text-center">
	<div class="col-lg-1" style="padding-top: 2rem;">
		<span style="font-size: 50px; color: #32CD32;" class="glyphicon glyphicon-ok" aria-hidden="true"></span>
	</div>	
	<div class="col-lg-1" style="padding-top: 2rem;">
		<span style="font-size: 50px;" class="glyphicon glyphicon-file" aria-hidden="true"></span>
	</div>	
